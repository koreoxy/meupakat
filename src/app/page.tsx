...
import { ArrowUpRight, Send, Star, Sparkles, Sun, Moon } from 'lucide-react';

const RobotIcon = () => (
  <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--color-ink-secondary)]">
...
const MeupakatLogoIcon = () => (
  <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--color-primary)]">
  ...
  return (
    <div className="min-h-screen bg-[var(--color-canvas)] text-[var(--color-ink)] relative overflow-hidden font-sans flex flex-col justify-between transition-colors duration-300">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, var(--color-secondary-purple) 0%, transparent 80%)' }}
      />
      ...
      <header className="max-w-7xl mx-auto w-full px-5 py-5 flex items-center justify-between z-10 relative">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-[var(--color-ink-muted)] font-medium">Learn Speaking. Every Day.</p>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto w-full px-5 py-10 lg:py-16 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center z-10 relative flex-1">
        ...
        <div className="lg:col-span-5 space-y-6 lg:text-left text-center flex flex-col lg:items-start items-center">
          ...
          >
            Bicara Inggris <br/>
            <span className="text-[var(--color-primary)]">Lancar & Berani</span> <br/>
            dalam Hitungan Hari!
          </motion.h2>
          ...
          >
            Latih percakapan interaktif privat bersama AI Tutor. Dilengkapi skenario kehidupan sehari-hari, koreksi tata bahasa langsung, dan sistem XP yang menyenangkan.
          </motion.p>
        ...
        <div className="lg:col-span-3 space-y-6 flex flex-col justify-center w-full">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-bold tracking-wider uppercase text-emerald-100">Rekomendasi</span>
            </div>
            ...
            <p className="text-[12px] text-emerald-55 leading-relaxed">
              Ikuti tes bicara interaktif 5 menit kami untuk mengetahui tingkat kemampuan bahasa Inggris Anda secara akurat.
            </p>
          ...
          >
            <div className="flex items-center gap-2">
              <div className="flex -space-x-2.5">
                <div className="w-7 h-7 rounded-full bg-[var(--color-primary)] text-white text-[9px] font-bold border-2 border-[var(--color-canvas)] flex items-center justify-center">L</div>
                <div className="w-7 h-7 rounded-full bg-[var(--color-secondary-purple)] text-white text-[9px] font-bold border-2 border-[var(--color-canvas)] flex items-center justify-center">J</div>
                <div className="w-7 h-7 rounded-full bg-[var(--color-success)] text-white text-[9px] font-bold border-2 border-[var(--color-canvas)] flex items-center justify-center">R</div>
              </div>
            ...
            <p className="text-[11px] text-[var(--color-ink-muted)] leading-relaxed">
              <span className="font-bold text-[var(--color-primary)]">98% siswa</span> merasakan peningkatan kelancaran berbicara setelah minggu pertama berlatih harian.
            </p>
          </motion.div>
      ...
      <footer className="max-w-7xl mx-auto w-full px-5 py-6 border-t border-[var(--color-hairline-soft)] text-center text-[11px] text-[var(--color-ink-muted)] z-10 relative">
        <p>© 2026 Meupakat. Dibuat untuk latihan percakapan bahasa Inggris interaktif. Gratis & Terbuka.</p>
      </footer>
