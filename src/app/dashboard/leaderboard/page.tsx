...
// Global Leaderboard — Liga Mingguan
  ...
  return (
    <div className="px-0 sm:px-6 lg:px-8 pt-6 pb-24 md:pb-10 space-y-5 animate-fade-in max-w-2xl mx-auto w-full">
      ...
      <div className="px-4 sm:px-0">
        <h1 className="font-display-md text-[var(--color-ink)]">🏆 Weekly League</h1>
        <p className="text-[13px] text-[var(--color-ink-muted)] mt-1">
          Compete weekly · XP resets every Sunday midnight
        </p>
      </div>
      ...
      {myRank && (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[13px] font-semibold text-[var(--color-ink)]">Your position this week</p>
            <p className="text-[12px] text-[var(--color-ink-muted)]">{myRank.weeklyXp} weekly XP</p>
          </div>
          <div
      ...
      <Card variant="default" padding="none">
        {isLoading ? (
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-[14px] font-semibold text-[var(--color-ink)]">No rankings yet!</p>
          ...
          <div className="divide-y divide-[var(--color-hairline)]">
            {leaderboard.map((entry) => {
              ...
              // Promotion zone (top 5 = green), degradation zone (bottom 5 = red)
              const isPromotion = entry.rank <= 5;
              const isDegradation = leaderboard.length > 10 && entry.rank >= leaderboard.length - 4;
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <p className="text-[10px] text-[var(--color-ink-muted)]">weekly XP</p>
                  </div>
                </div>
              );
            })}
      ...
      <div className="flex gap-4 px-4 sm:px-0 flex-wrap">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[11px] text-[var(--color-ink-muted)]">Promotion zone (top 5)</span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-4 rounded-sm" style={{ background: '#e45858' }} />
          <span className="text-[11px] text-[var(--color-ink-muted)]">Demotion zone (bottom 5)</span>
        </div>
      </div>
    </div>
  );
